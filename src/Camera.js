...
// var resData=[];
    ...
    let url = "https://oj8t2gwbvk.execute-api.ap-south-1.amazonaws.com/em/upload/";
...
// .then((todo)=> setList(todo.data));
 ...
 >
      ...
      {/* <label htmlFor="icon-button-file">
            ...
            <div>
            {selectedFile &&  (<div><img src={preview} alt="demo" width="200px" height="200px"/> <div>   <Button  className={classes.margins} type="submit" variant="contained" color="primary" onClick={onSubmit}><b>submit</b></Button></div>
            </div>)}
      ...
      <Box my={10
        ...
        <h4 style={{ color: " #145a32", fontSize: "20px", textAlign: 'center' }}>Image analysis</h4>
        <Grid
          container
          direction="row"
          justify="center"
          ...
          <Card elevation={9} className={classes.root}>
            <CardContent>
              ...
              <Typography variant="h5" component="h2">
                <span><b style={{ color: " #145a32", fontSize: "20px" }}>
                  <div>
          ...
          <Card elevation={9} className={classes.root}>
            <CardContent>
              ...
              <Typography variant="h5" component="h2">
                <span><b style={{ color: " #145a32", fontSize: "20px" }}>
                  <div>
                    {state.map((d)=> {
                      return (
                        <div key={state.id}>
                          {state[1].Average_Length}<span><b style={{ color: " #145a32", fontSize: "15px" }}></b></span>
                          <div className={classes.pos1}>
                            <Tooltip title={state[1].Average_Length} arrow>
                              <InfoOutlinedIcon style={{ fontSize: "15px" }} />
                            </Tooltip>
                          </div>
                        </div>
                ...
                </b></span><span><b style={{ color: " #145a32", fontSize: "15px" }}></b></span>
              </Typography>
            </CardContent>
          </Card>
        </Grid>
                ...
                <span><b style={{ color: " #145a32", fontSize: "20px" }}>
                  <div>
                    {state.map((d)=> {
                      return (
                         <div key={state.id}>
                          {state[1]["Average_Circumference_Dia "] }<span><b style={{ color: " #145a32", fontSize: "15px" }}></b></span>
                          <div className={classes.pos1}> 
                            <Tooltip title={state[1]["Average_Circumference_Dia "]} arrow>
                              <InfoOutlinedIcon style={{ fontSize: "15px" }} />
                            </Tooltip>
                           </div>
                        </div> 
 ...
 */}
 ...
 <Box my={10}>
        <h4 style={{ color: " #145a32", fontSize: "20px", textAlign: 'center' }}>Range analysis</h4>
        <Grid
          container
          direction="row"
          justify="center"
                  ...
                  <div key={d}>
                    <CardContent>
                      ...
                      <Typography className={classes.continue} color="textSecondary">
                        <Tooltip title={state[2]["Range : 8+"][0]} arrow>
                          <InfoOutlinedIcon style={{ fontSize: "15px" }} />
                        </Tooltip>
                      </Typography>
                    </CardContent>
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        <b style={{ color: 'black' }}> {state[2]["Range : 8+"][0]} seeds</b> out of <span style={{ color: 'black' }}>{state[2]["Total : "][0]}</span>({state[2]["Range : 8+"][1]}of total)
        </Typography>
                      <Typography className={classes.continues} color="textSecondary">
                        Current:<span style={{ color: 'black' }}>₹NA/kg</span>
                      </Typography>
                    </CardContent>
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        %not broken:<span>{state[2]["Range : 8+"][2]}%</span>
                      </Typography>
                      <Typography className={classes.continues} color="textSecondary">
                        Forecast:<span style={{ color: 'black' }}>₹NA/kg</span>
                      </Typography>
                    </CardContent>
                ...
                return (
                  <div>
                    <CardContent>
                      ...
                      <Typography className={classes.continue} color="textSecondary">
                        <Tooltip title={state[2]["Range : 7.5 - 8"][0]} arrow>
                          <InfoOutlinedIcon style={{ fontSize: "15px" }} />
                        </Tooltip>
                      </Typography>
                    </CardContent>
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        <b style={{ color: 'black' }}> {state[2]["Range : 7.5 - 8"][0]} seeds</b> out of <span style={{ color: 'black' }}>{state[2]["Total : "][0]}</span>({state[2]["Range : 7.5 - 8"][1]}%of total)
                     </Typography>
                      <Typography className={classes.continues} color="textSecondary">
                        Current:<span style={{ color: 'black' }}>₹NA/kg</span>
                      </Typography>
                    ...
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        %not broken:<span>{state[2]["Range : 7.5 - 8"][2]}%</span>
                      </Typography>
                      <Typography className={classes.continues} color="textSecondary">
                        Forecast:<span style={{ color: 'black' }}>₹NA/kg</span>
                      </Typography>
                ...
                return (
                  <div>
                    <CardContent>
                      ...
                      <Typography className={classes.continue} color="textSecondary">
                        <Tooltip title={state[2]["Range : 7 - 7.5"][0]} arrow>
                          <InfoOutlinedIcon style={{ fontSize: "15px" }} />
                        </Tooltip>
                      </Typography>
                    </CardContent>
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        <b style={{ color: 'black' }}> {state[2]["Range : 7 - 7.5"][0]} seeds</b> out of <span style={{ color: 'black' }}>{state[2]["Total : "][0]}</span>({state[2]["Range : 7 - 7.5"][1]}%of total)
        </Typography>
                      <Typography className={classes.continues} color="textSecondary">
                        Current:<span style={{ color: 'black' }}>₹NA/kg</span>
                      </Typography>
                    ...
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        %not broken:<span>{state[2]["Range : 7 - 7.5"][2]}%</span>
                      </Typography>
                      <Typography className={classes.continues} color="textSecondary">
                        Forecast:<span style={{ color: 'black' }}>₹NA/kg</span>
                      </Typography>
                ...
                return (
                  <div>
                    <CardContent>
                      ...
                      <Typography className={classes.continue} color="textSecondary">
                        <Tooltip title={state[2]["Range : 6.5 - 7"][0]} arrow>
                          <InfoOutlinedIcon style={{ fontSize: "15px" }} />
                        </Tooltip>
                      </Typography>
                    </CardContent>
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        <b style={{ color: 'black' }}> {state[2]["Range : 6.5 - 7"][0]} seeds</b> out of <span style={{ color: 'black' }}>{state[2]["Total : "][0]}</span>({state[2]["Range : 6.5 - 7"][1]}%of total)
        </Typography>
                      <Typography className={classes.continues} color="textSecondary">
                        Current:<span style={{ color: 'black' }}>₹NA/kg</span>
                      </Typography>
                    ...
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        %not broken:<span>{state[2]["Range : 6.5 - 7"][2]}%</span>
                      </Typography>
                      <Typography className={classes.continues} color="textSecondary">
                        Forecast:<span style={{ color: 'black' }}>₹NA/kg</span>
                      </Typography>
                ...
                return (
                  <div>
                    <CardContent>
                      ...
                      <Typography className={classes.continue} color="textSecondary">
                        <Tooltip title={state[2]["Range : 6 - 6.5"][0]} arrow>
                          <InfoOutlinedIcon style={{ fontSize: "15px" }} />
                        </Tooltip>
                      </Typography>
                    </CardContent>
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        <b style={{ color: 'black' }}> {state[2]["Range : 6 - 6.5"][0]} seeds</b> out of <span style={{ color: 'black' }}>{state[2]["Total : "][0]}</span>({state[2]["Range : 6 - 6.5"][1]}%of total)
        </Typography>
                      <Typography className={classes.continues} color="textSecondary">
                        Current:<span style={{ color: 'black' }}>₹NA/kg</span>
                      </Typography>
                    ...
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        %not broken:<span>{state[2]["Range : 6 - 6.5"][2]}%</span>
                      </Typography>
                      <Typography className={classes.continues} color="textSecondary">
                        Forecast:<span style={{ color: 'black' }}>₹NA/kg</span>
                      </Typography>
                ...
                return (
                  <div>
                    <CardContent>
                      ...
                      <Typography className={classes.continue} color="textSecondary">
                        <Tooltip title={state[2]["Range : 0 - 6 (broken)"][0]} arrow>
                          <InfoOutlinedIcon style={{ fontSize: "15px" }} />
                    ...
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        <b style={{ color: 'black' }}> {state[2]["Range : 0 - 6 (broken)"][0]} seeds</b> out of <span style={{ color: 'black' }}>{state[2]["Total : "][0]}</span>({state[2]["Range : 0 - 6 (broken)"][2]}%of total)
                          </Typography>
                    ...
                    <CardContent>
                      <Typography className={classes.backs} color="textSecondary" gutterBottom>
                        %not broken:<span>{state[2]["Range : 0 - 6 (broken)"][2]}%</span>
                      </Typography>
   ...
   <Box my={14}>
      ...
      <div style={{ paddingbottom: "20px" }}>
        <Box my={-9}>
          <Grid margin={0}>
            <div>
              <Button variant="contained" className={classes.margins} onClick={print}><b>Save PDF</b></Button>
            </div>
          </Grid>
        </Box>
      </div>
